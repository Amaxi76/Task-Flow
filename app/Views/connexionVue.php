	...
	<div class="d-flex justify-content-center align-items-center vh-100">
        <div class="box shadow-lg d-flex flex-row">
            ...
            <div class="md-6 bg-custom text-white p-4">
				...
				<?php echo form_open('ConnexionControleur/connexion', ['class' => 'needs-validation', 'novalidate' => '']); ?>
				...
				<p class="text-center mt-3">
					<a href="/MotDePasseOublie/envoieMail" class="text-white">Mot de passe oublié ?</a>
				</p>
			</div>
		</div>
    </div>
